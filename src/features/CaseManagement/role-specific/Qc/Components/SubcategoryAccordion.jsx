...
import { getPrevverifyData } from "@/Services/AgentServices";
...
import QCFinalizeVerificationModal from "./QCFinalizeVerificationModal";
import { finalizeQCVerifyCaseService } from "@/Services/QCService";
...
const SubcategoryAccordion = ({
    ...
    console.log(subCategory, "subcategory in accordion");
    ...
    const handleFinalizeVerification = (payload) => {
        return finalizeQCVerifyCaseService(payload);
    };
            ...
            <summary className={`cursor-pointer list-none px-4 py-3 flex items-center justify-between gap-1 border-l-4 rounded-lg 
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                        <span className={`px-2 py-0.5 rounded-full ${status?.className}`}>
                            {status?.text}
                        </span>
                    </p>
                </div>
                ...
                <div className="flex items-center gap-2 shrink-0">
                    {!isEditing && isVerificationLoaded && (
                        <>
                            {/* <button
                                type="button"
                            ...
                            <CustomButton onClick={() => setIsOpenHistory((prev) => !prev)} >
                                View History
                            </CustomButton>
                        </>
                    )}
